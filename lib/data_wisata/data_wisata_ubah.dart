...
class DataWisataUbahScreen extends StatefulWidget {
  static const routeName = "data_wisata/edit";
  const DataWisataUbahScreen({super.key});

  @override
  State<DataWisataUbahScreen> createState() => _DataWisataUbahScreenState();
}

class _DataWisataUbahScreenState extends State<DataWisataUbahScreen> {
  EnumRemote enumRemote = EnumRemote();

  DataWisataUbahArguments? screenArgument;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      screenArgument =
          ModalRoute.of(context)!.settings.arguments as DataWisataUbahArguments;

      if (screenArgument != null) {
        idWisataController.text = screenArgument?.data.idWisata ?? "";
        namaWisataController.text = screenArgument?.data.namaWisata ?? "";
        fotoController.text = screenArgument?.data.foto ?? "";
        deskripsiController.text = screenArgument?.data.deskripsi ?? "";
        koordinatController.text = screenArgument?.data.koordinat ?? "";
  ...
  Widget build(BuildContext context) {
    ...
    */
    ...
    return BlocListener(
      bloc: BlocProvider.of<DataWisataUbahBloc>(context),
      listener: ((context, state) {
        ...
        if (state is DataWisataUbahLoadFailure) {
          const snackBar = SnackBar(
      ...
      child: BlocBuilder<DataWisataUbahBloc, DataWisataUbahState>(
                        ...
                        children: [
                          ...
                          SizedBox(
                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () {
                                  BlocProvider.of<DataWisataUbahBloc>(context)
                                      .add(FetchDataWisataUbah(form));
                                },
                                child: state is DataWisataUbahLoading
...
class DataWisataUbahArguments {
  final DataWisata data;
  final String judul;

  DataWisataUbahArguments({
    required this.data,
    required this.judul,
  });
}
