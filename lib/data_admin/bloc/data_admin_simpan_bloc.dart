...
// import 'package:recomend_toba/data_admin/repo/DataAdminSimpan_local.dart';
import 'package:recomend_toba/utils/network_info.dart';

class DataAdminSimpanBloc
    extends Bloc<DataAdminSimpanEvent, DataAdminSimpanState> {
  ...
  DataAdminSimpanBloc() : super(DataAdminSimpanInitial()) {
    on<FetchDataAdminSimpan>(((event, emit) async {
      ...
      try {
        ...
        emit(
          const DataAdminSimpanLoadFailure(
