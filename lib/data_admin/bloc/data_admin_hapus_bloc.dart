...
// import 'package:recomend_toba/data_admin/repo/DataAdminHapus_local.dart';
import 'package:recomend_toba/utils/network_info.dart';

class DataAdminHapusBloc
    extends Bloc<DataAdminHapusEvent, DataAdminHapusState> {
...
*/
      try {
        final DataAdminResultApi response = await remoteRepo.hapus(event.data);
        emit(DataAdminHapusLoadSuccess());
      } catch (e) {
        debugPrint(e.toString());
        emit(const DataAdminHapusLoadFailure(
