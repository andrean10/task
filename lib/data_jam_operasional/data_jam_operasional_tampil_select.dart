            ...
            Row(
              ...
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () {
                    showModalBottomSheet<DataJamOperasionalApiData>(
                      context: context,
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: ElevatedButton(
                                    onPressed: () {
                                      if (jamOperasionalController.text
                                          .contains(',')) {
                                      ...
                                      final newData = widget.data.copyWith(
                                        nilai:
                                            jamOperasionalController.value.text,
                                      );

                                      final bloc = context
                                          .read<DataJamOperasionalUbahBloc>();
                                      bloc.add(
                                        FetchDataJamOperasionalUbah(
                                          DataJamOperasional(
                                            idJamOperasional:
                                                newData.idJamOperasional,
                                            nilai: newData.nilai,
                                          ),
                                        ),
                                      );
